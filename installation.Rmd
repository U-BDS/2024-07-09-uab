...
Additional Office Hours will be hosted to assist with any questions or concerns that may occur during the installation process. The dates and times for these more focused Office Hour sessions are listed below, and the Zoom link is available [here](https://uab.zoom.us/meeting/register/tZ0rduCuqzotGtHShsawHLyRROqH3Sdz71mf).
